...
<b>Title:</b>
Free and For Sale  
= Team Members: Michael Chen, Nhi Quach, Hubert Tsen, Jason Xie  
= Demo Link:   
= Idea: An application like the Berkeley Free and For Sale page. Users can make, edit, and delete postings and comment on other postings  
